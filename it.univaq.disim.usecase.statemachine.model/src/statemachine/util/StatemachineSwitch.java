...
public class StatemachineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StatemachinePackage.SITUATION: {
			...
			case StatemachinePackage.ABSTRACT_EVENT: {
			...
			case StatemachinePackage.COMMAND: {
				...
				if (result == null) result = caseAbstractEvent(command);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StatemachinePackage.RESET: {
